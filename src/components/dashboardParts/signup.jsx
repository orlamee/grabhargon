              ...
              <div className="sign-form">
                ...
                <div className="mt-5">
                  <div className="login-cards">
                    ...
                    <i className="bi bi-chevron-right float-end" style={{marginTop: "-38px"}}></i>
                  </div>
                  <div className="login-cards">
                    <div className="d-flex flex-row">
                      <img src={company} alt="merchant" className="img-fluid" />
                      <div className="ms-3">
                        <h3>Company</h3>
                        <p>Select which type of account you want to open</p>
                      </div>
                  ...
                  <div className="login-cards">
                    <div className="d-flex flex-row">
                      <img src={agent} alt="merchant" className="img-fluid" />
                      <div className="ms-3">
                        <h3>Agents</h3>
                        <p>Select which type of account you want to open</p>
                      </div>
                  ...
                  <div className="login-cards">
                    <div className="d-flex flex-row">
                      <img src={partner} alt="merchant" className="img-fluid" />
                      <div className="ms-3">
                        <h3>Partnership</h3>
                        <p>Select which type of account you want to open</p>
                      </div>
                  ...
                  <p className="text-black">Already have an account?  <Link to="/login" className="" style={{color: "#23A323"}}>Sign In </Link></p>
                </div>
              </div>
            </div>
          </div>
