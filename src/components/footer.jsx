          ...
          <div className="row navigation justify-content-between">
            <div className="col-sm-3 mb-3">
              ...
              <p className="text-white w-75">
                Fuel your dreams, sustain, and grow your business with reliable
                lending solutions.
              </p>
              <Link
                to="/grabhargon"
              ...
              <div className="row">
                <div className="col-sm mb-3">
                  ...
                  <ul className="list-unstyled links">
                    <li>
                      <Link to="/integration">
                        Integration <span className="f-cs">Coming Soon</span>
                      </Link>
                    </li>
                  </ul>
                  ...
                  <ul className="list-unstyled links">
                    <li>
                      <Link to="/press-media">Press</Link>
                    </li>
                    <li>
                ...
                <div className="col-sm mb-3">
                  ...
                  <ul className="list-unstyled links">
                    ...
                    <li>
                      <Link to="">
                        Partnership <span className="f-cs">Coming Soon</span>
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/credit-builder">
                        Credit builder <span className="f-cs">Coming Soon</span>
                      </Link>
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-sm mb-3">
                  ...
                  <ul className="list-unstyled links">
                    <li>
                      <Link>33B, Ogundana street, Allen, Ikeja.</Link>
                    </li>
                  </ul>
                  <h5>Contact</h5>
                  <ul className="list-unstyled links">
                    <li>
                      <a href="mailto:support@hargon.africa">
                        Support@hargon.africa
                      </a>
                    </li>
                    <li>
                      <Link>+234 813 029 2726</Link>
                    </li>
                  </ul>
